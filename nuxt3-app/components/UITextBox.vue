...
<template>
  <div class="UITextBox">
    ...
    <input
      v-else
      class="block px-2 py-1 text-gray-900 bg-gray-50 border border-gray-300 rounded-md outline-none disabled:text-gray-400 focus:ring-2 focus:ring-blue-200 focus:border-blue-500"
      :class="[
