...
<template>
  <div class="TextArea">
    ...
    <textarea :placeholder="placeholder"
      ...
      @input="onInput"
      @blur="onBlur"
      class="p-2 text-sm text-gray-900 bg-gray-50 resize-none border border-gray-300 rounded-md outline-none focus:ring-2 focus:ring-blue-200 focus:border-blue-500"
      :class="[
        {
          'block': !halign,
          'w-full': !halign,
